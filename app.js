...
(function(){
  ...
  document.addEventListener('click', function(e){
    var t = e.target;
    if(t && t.getAttribute && t.getAttribute('data-close') === 'forgot'){
      e.preventDefault();
      _closeForgotOnly();
      return false;
    }
...
(() => {
  ...
  function doLogout_(){
    // Login disabled: treat "logout" as a soft reset.
  ...
  (function bootAuth_(){
    // Restore session (if exists) or require login
