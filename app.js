...
// Keep wizard title in sync
  ...
  function renderOldPoliciesStep(){
    ...
    $('#addOldBtn').addEventListener('click', () => {
      ...
      p.oldPolicies.push({ insuredId, company, product, policyNo, premium, sumInsured: (isSumProduct(product)? sumInsured : undefined), compensation: (isCompProduct(product)? compensation : undefined), decision, partialCancelNotes });
