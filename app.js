...
// ---------- CONFIG (Google Sheets via Apps Script Web App) ----------
  ...
  function setRoute(r){
    ...
    route = r;
    $$('.navItem[data-route]').forEach(b => b.classList.toggle('active', b.dataset.route === r));
    render();
  }

  $$('.navItem[data-route]').forEach(b => b.addEventListener('click', () => setRoute(b.dataset.route)));
