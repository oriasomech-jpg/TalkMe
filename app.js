...
function openReflect_(){
  ...
  // reset lightweight UI state each open (keeps it clean)
  reflectState.customer = null;
  reflectState.proposal = null;
  reflectState.stepIndex = 0;

  if(reflectSearch) reflectSearch.value = '';
  renderReflectResults_('');
  renderReflect_();
