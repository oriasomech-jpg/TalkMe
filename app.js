...
/* Stage 2 – Main consideration (3 options) */
.triChoiceRow{
  display:flex;
  align-items:center;
  gap:10px;
...
.triChoiceBtn{
  ...
  border-radius:999px;
  cursor:pointer;
  box-shadow: 0 6px 18px rgba(18,19,25,.06);
  transition: transform .08s ease, box-shadow .12s ease, background .12s ease, border-color .12s ease;
}
.triChoiceBtn:hover{ transform: translateY(-1px); box-shadow: 0 10px 22px rgba(18,19,25,.08); }
.triChoiceBtn.on{
  border-color: rgba(214,178,94,.55);
  background: rgba(214,178,94,.18);
}

/* Stage 3 modal: reuse same look */
#stage3Modal .stage2Script{
  padding:12px 12px;
  border-radius:14px;
  background: rgba(214,178,94,.10);
  border:1px solid rgba(214,178,94,.18);
