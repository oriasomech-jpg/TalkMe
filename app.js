...
// ---------- CONFIG (Google Sheets via Apps Script Web App) ----------
  ...
  const CHECKLIST_STEPS = [
    {
      id:'intro',
      title:'הצגת עצמך מלאה',
      required:true,
      items:[
        'שלום, אני מדבר/ת עם ___?',
        'הצגתי את עצמי (שם נציג)',
        'ציינתי “מטעם סוכן ___”',
        'ציינתי “משווק ביטוחים של חברת ___”',
        'שאלתי “מה שלומך?”'
      ]
    },
    {
      id:'recording',
      title:'מטרת השיחה וקבלת אישור מוקלטת',
      required:true,
      items:[
        'הסברתי את מטרת השיחה (הצעת רכישת ביטוח)',
        'הדגשתי שזו שיחת מכירה מוקלטת',
        'קיבלתי אישור להמשיך בשיחה'
      ]
    },
    {
      id:'insured',
      ...
      required:true,
      items:[
        'אספתי שם מלא, ת"ז, תאריך לידה',
        'אספתי מצב משפחתי + ילדים',
        'אספתי עיסוק + קופ"ח + שב"ן',
        'בדקתי עישון בשנתיים האחרונות',
        'אספתי הכנסה נטו + אופן קבלת דיוורים'
      ]
    },
    {
      id:'market',
      title:'עדכון שוק / חברות עיקריות',
      required:false,
      items:[
        'עדכנתי שיש 8 (בריאות) / 9 (חיים) חברות',
        'ציינתי חברות עיקריות בתחום הבריאות',
        'ציינתי חברות עיקריות בתחום החיים'
      ]
    },
    {
      id:'har',
      title:'אישור כניסה להר הביטוח + בדיקה',
      required:true,
      items:[
        'קיבלתי אישור להיכנס להר הביטוח',
        'ביצעתי בדיקה והרשמתי תוצאה'
      ]
    },
    {
      id:'existing',
      title:'ביטוחים קיימים',
      required:false,
      items:[
        'הצגתי ביטוחים קיימים (סוג/חברה/פרמיה)',
        'במידה ואין—קיבלתי אישור שאין ביטוח פרטי'
      ]
    },
    {
      id:'offer',
      title:'הצעת הפוליסה החדשה + שיקולים',
      required:true,
      items:[
        'הצגתי את הפוליסה המוצעת (סוג/חברה/שם)',
        'פירטתי שיקולים עיקריים להמלצה',
        'ציינתי שישלח מסמך השוואה כתוב לחתימה'
      ]
    },
    {
      id:'health_base',
      title:'בריאות – פוליסת בסיס לפני הרחבות',
      required:false,
      items:[
        'הדגשתי קודם בסיס ואז ניתוחים בארץ/חו״ל',
        'במידה ונרכש “פתחון בישראל” — פרטתי 3 אפשרויות'
      ]
    },
    {
      id:'premium',
      title:'פרמיה / הנחה מדורגת / הצמדה',
      required:false,
      items:[
        'הצגתי פרמיה חודשית (פירוט לפי כיסויים)',
        'הצגתי פרמיה לפי הנחה',
        'ציינתי הנחה מדורגת (שנים א׳–ו׳)',
        'ציינתי הצמדה למדד + ייתכן חיוב ראשון כפול'
      ]
    },
    {
      id:'cancel',
      title:'הקטנה/ביטול פוליסה קיימת (אם צריך)',
      required:false,
      items:[
        'שאלתי האם להקטין/לבטל פוליסה קיימת בעקבות הרכישה',
        'אם כן — בחרנו דרך טיפול בביטול + טופס ביטול',
        'אם לא — קיבלתי אישור לרכישת כיסוי כתוספת'
      ]
    },
    {
      id:'authorized',
      title:'גורם מוסמך בפוליסה',
      required:false,
      items:[
        'זיהיתי מי הגורם המוסמך לביצוע פעולות בפוליסה'
      ]
    },
    {
      id:'health_decl',
      title:'הצהרות בריאות (כולל ילדים)',
      required:true,
      items:[
        'הבהרתי חשיבות תשובות מלאות/כנות',
        'הסברתי שמענה לא נכון יכול לפגוע בתביעה/לבטל פוליסה',
        'אם יש ילדים — הדגשתי שהשאלות גם על הילדים'
      ]
    },
    {
      id:'pay',
      title:'אמצעי תשלום ואישור גבייה',
      required:true,
      items:[
        'בחרנו אמצעי תשלום (אשראי/הו״ק) ומילאנו פרטים',
        'במקרה של משלם חריג — בוצעה שיחת אימות',
        'קיבלתי אישור לגבייה מאמצעי התשלום'
      ]
    },
    {
      id:'start',
      title:'תוקף פוליסה + הודעת SMS מהחברה',
      required:false,
      items:[
        'ציינתי מועד תחילת תוקף / מועד הפקה לפי המאוחר',
        'הנחיתי לעקוב ולאשר הודעת SMS מהחברה'
      ]
    },
    {
      id:'final',
      title:'מסמכים + אישור רכישה + סיום',
      required:true,
      items:[
        'ציינתי שהמידע שנמסר נכון ומדויק',
        'הסברתי על אתר “הר הביטוח”',
        'נשלח טופס הצעה/מסמכים לחתימה',
        'קיבלתי אישור סופי לרכישת הפוליסה',
        'שאלתי אם יש שאלות נוספות וסיימתי בנימוס'
      ]
    }
  ];

  const CHECKLIST_LS_KEY = 'gemel_call_checklist_v1';

  function checklistKey_(customerId){
    const cid = customerId ? String(customerId) : 'general';
    const agent = String(state.agentName || 'אורח');
    const day = new Date().toISOString().slice(0,10);
    return `${CHECKLIST_LS_KEY}::${cid}::${agent}::${day}`;
  }

  function loadChecklist_(customerId){
    try{
      const raw = localStorage.getItem(checklistKey_(customerId));
    ...
    const init = {
      ...
      openStepId: CHECKLIST_STEPS[0]?.id || 'intro',
      steps: {}
    };
    CHECKLIST_STEPS.forEach(s => {
      init.steps[s.id] = { done:false, items: Array(s.items.length).fill(false), notes:'' };
    });
    return init;
  }
  ...
  function saveChecklist_(data){
    try{
      ...
      localStorage.setItem(checklistKey_(data.customerId), JSON.stringify(data));
    }catch(_){}
  }

  function checklistProgress_(data){
    const total = CHECKLIST_STEPS.length;
    let done = 0;
    CHECKLIST_STEPS.forEach(s => {
      if(data.steps?.[s.id]?.done) done++;
    });
    const pct = total ? Math.round((done/total)*100) : 0;
    return { done, total, pct };
  }

  function stepStatus_(data, step){
    const st = data.steps?.[step.id];
    if(!st) return { cls:'', text:'—' };
    const all = (st.items||[]).every(Boolean);
    if(st.done) return { cls:'ok', text:'הושלם' };
    if((st.items||[]).some(Boolean)) return { cls:'warn', text: all ? 'מוכן לסגירה' : 'בתהליך' };
    return { cls:'', text:'לא התחיל' };
  }

  function renderChecklistPage(){
    const vis = visibleCustomers_();
    const currentId = (window.__checklistCustomerId ?? '') || '';
    const data = loadChecklist_(currentId);
    const prog = checklistProgress_(data);

    viewEl.innerHTML = `
      <div class="checklistPage">
        <div class="checklistTop">
          <div>
            <h2 class="title">צ׳קליסט שיחה</h2>
            <div class="hint">מסדר את הרצף לנציג • שומר התקדמות מקומית</div>
          </div>
          <div class="checklistControls">
            <select class="input" id="checkCustomer">
              <option value="">כללי (בלי לקוח)</option>
              ${vis.map(c => `<option value="${escapeAttr(c.id)}" ${String(c.id)===String(currentId)?'selected':''}>${escapeHtml(c.fullName||'')} • ${escapeHtml(c.tz||'')}</option>`).join('')}
            </select>
            <button class="btn btnSoft" id="checkReset">איפוס ליום</button>
            <button class="btn" id="checkExport">הפק דוח</button>
          </div>
        </div>

        <div class="checklistProgress">
          <div class="checklistProgressRow">
            <div><b>${escapeHtml(String(prog.done))}</b> / ${escapeHtml(String(prog.total))} שלבים הושלמו</div>
            <div style="font-weight:900">${escapeHtml(String(prog.pct))}%</div>
          </div>
          <div class="checkBar"><div style="width:${prog.pct}%"></div></div>
        </div>

        <div class="checklistGrid">
          ${CHECKLIST_STEPS.map(step => {
            const st = stepStatus_(data, step);
            const open = (data.openStepId === step.id) ? 'open' : '';
            return `
              <div class="checkStep ${open}" data-step="${escapeAttr(step.id)}">
                <div class="checkStepHead" data-step-head="${escapeAttr(step.id)}">
                  <div class="left">
                    <div class="checkPill ${st.cls}">${escapeHtml(st.text)}</div>
                    <div style="min-width:0">
                      <div class="checkStepTitle">${escapeHtml(step.title)}</div>
                      <div class="checkStepMeta">${step.required ? 'חובה' : 'אופציונלי'} • ${escapeHtml(String(step.items.length))} סעיפים</div>
                    </div>
                  </div>
                  <div style="font-size:12px;color:rgba(15,17,22,.55)">פתח</div>
                </div>

                <div class="checkStepBody">
                  <div class="checkItems">
                    ${step.items.map((txt, i) => {
                      const checked = !!(data.steps?.[step.id]?.items?.[i]);
                      return `
                        <div class="checkItem">
                          <input type="checkbox" data-step-item="${escapeAttr(step.id)}" data-idx="${i}" ${checked?'checked':''}>
                          <div>
                            <label>${escapeHtml(txt)}</label>
                          </div>
                        </div>
                      `;
                    }).join('')}
                  ...
                  <div class="checkNotes">
                    <div style="font-size:12px;color:rgba(15,17,22,.65);margin:10px 0 6px">הערות (אופציונלי)</div>
                    <textarea class="input" data-step-notes="${escapeAttr(step.id)}" placeholder="לדוגמה: הסתייגות הלקוח / מה סוכם">${escapeHtml(data.steps?.[step.id]?.notes || '')}</textarea>
                  </div>

                  <div class="checkActions">
                    <button class="btn btnSoft" data-step-prev="${escapeAttr(step.id)}">הקודם</button>
                    <button class="btn btnSoft" data-step-next="${escapeAttr(step.id)}">הבא</button>
                    <button class="btn" data-step-done="${escapeAttr(step.id)}">סמן שלב הושלם ✅</button>
                  </div>
                </div>
              </div>
            `;
    ...
    // persist current selection (and init entry)
    saveChecklist_(data);

    wireChecklistPage_(data);
  }

  function wireChecklistPage_(data){
    const select = document.getElementById('checkCustomer');
    const resetBtn = document.getElementById('checkReset');
    const exportBtn = document.getElementById('checkExport');

    const rerender = (customerId) => {
      window.__checklistCustomerId = customerId || '';
      renderChecklistPage();
    };

    if(select){
      select.addEventListener('change', () => rerender(select.value));
    }

    if(resetBtn){
      resetBtn.addEventListener('click', () => {
        if(!confirm('לאפס את הצ׳קליסט ליום הנוכחי?')) return;
        try{ localStorage.removeItem(checklistKey_(data.customerId)); }catch(_){}
        rerender(data.customerId || '');
      });
    }

    if(exportBtn){
      exportBtn.addEventListener('click', () => {
        const fresh = loadChecklist_(data.customerId);
        const lines = [];
        const customer = fresh.customerId ? (state.customers||[]).find(c=>c.id===fresh.customerId) : null;
        lines.push('צ׳קליסט שיחה • GEMEL INVEST');
        lines.push('תאריך: ' + new Date().toLocaleString('he-IL'));
        lines.push('נציג: ' + (fresh.agentName || state.agentName || ''));
        if(customer){
          lines.push('לקוח: ' + (customer.fullName||'') + ' • ת״ז: ' + (customer.tz||''));
        }else{
          lines.push('לקוח: כללי');
        }
        lines.push('---');
        CHECKLIST_STEPS.forEach(step => {
          const st = stepStatus_(fresh, step);
          lines.push(`• ${step.title} — ${st.text}`);
          (step.items||[]).forEach((t,i) => {
            const ok = !!fresh.steps?.[step.id]?.items?.[i];
            lines.push(`   - [${ok?'x':' '}] ${t}`);
          });
          const notes = String(fresh.steps?.[step.id]?.notes || '').trim();
        ...
        a.href = url;
        a.download = 'checklist_' + (customer? (customer.fullName||'customer') : 'general') + '_' + new Date().toISOString().slice(0,10) + '.txt';
        document.body.appendChild(a);
        a.click();
        a.remove();
        setTimeout(()=>URL.revokeObjectURL(url), 1200);
        toast('מוכן', 'הדוח הופק והורד למחשב');
      });
    }

    // Step toggles
    $$('[data-step-head]').forEach(el => el.addEventListener('click', () => {
      const sid = el.dataset.stepHead;
      data.openStepId = sid;
      saveChecklist_(data);
      renderChecklistPage();
    }));
    ...
    // item checkbox
    $$('[data-step-item]').forEach(cb => cb.addEventListener('change', () => {
      const sid = cb.dataset.stepItem;
      const idx = Number(cb.dataset.idx);
      const fresh = loadChecklist_(data.customerId);
      if(fresh.steps?.[sid]?.items && idx >= 0){
        fresh.steps[sid].items[idx] = !!cb.checked;
        // auto done if all items checked
        const all = fresh.steps[sid].items.every(Boolean);
        fresh.steps[sid].done = all;
        saveChecklist_(fresh);
      }
      renderChecklistPage();
    }));

    // notes
    $$('[data-step-notes]').forEach(t => t.addEventListener('input', () => {
      const sid = t.dataset.stepNotes;
      const fresh = loadChecklist_(data.customerId);
      if(fresh.steps?.[sid]){
        fresh.steps[sid].notes = String(t.value || '');
        saveChecklist_(fresh);
      }
    }));

    // done/prev/next
    $$('[data-step-done]').forEach(b => b.addEventListener('click', () => {
      const sid = b.dataset.stepDone;
      const fresh = loadChecklist_(data.customerId);
      const st = fresh.steps?.[sid];
      if(!st) return;
      const all = (st.items||[]).every(Boolean);
      if(!all){
        toast('חסר', 'כדי לסמן “הושלם” יש להשלים את כל הסעיפים בשלב');
        return;
      }
      st.done = true;
      // move to next
      const i = CHECKLIST_STEPS.findIndex(s => s.id === sid);
      const next = CHECKLIST_STEPS[i+1]?.id || sid;
      fresh.openStepId = next;
      saveChecklist_(fresh);
      toast('עודכן', 'שלב סומן כהושלם');
      renderChecklistPage();
    }));

    $$('[data-step-prev]').forEach(b => b.addEventListener('click', () => {
      const sid = b.dataset.stepPrev;
      const i = CHECKLIST_STEPS.findIndex(s => s.id === sid);
      const prev = CHECKLIST_STEPS[Math.max(0, i-1)]?.id || sid;
      const fresh = loadChecklist_(data.customerId);
      fresh.openStepId = prev;
      saveChecklist_(fresh);
      renderChecklistPage();
    }));

    $$('[data-step-next]').forEach(b => b.addEventListener('click', () => {
      const sid = b.dataset.stepNext;
      const i = CHECKLIST_STEPS.findIndex(s => s.id === sid);
      const next = CHECKLIST_STEPS[Math.min(CHECKLIST_STEPS.length-1, i+1)]?.id || sid;
      const fresh = loadChecklist_(data.customerId);
      fresh.openStepId = next;
      saveChecklist_(fresh);
      renderChecklistPage();
...
// ---------- UI references ----------
  ...
  function render(){
    ...
    if(route === 'checklist'){
      pageTitleEl.textContent = 'צ׳קליסט שיחה';
      crumbEl.textContent = 'Call';
      kpisEl.innerHTML = '';
      if(tabsEl){ tabsEl.innerHTML = ''; tabsEl.style.display = 'none'; }
      renderChecklistPage();
    }
